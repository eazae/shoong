...
const getTokenBalance = async(address,contractAddr,decimals)=> {
  // 토큰 잔액 조회
  let minABI = [
      // balanceOf
      {
  ...
  switch(decimals){
    ...
    break;
    case 6:
    convertToken = web3.utils.fromWei(contractMethod.toString(),'Mwei')
    break;
  }
...
export {getEthBalance, getTokenBalance};